...
export default function Faq() {
  ...
  return (
    <div>
      <h1 className="font-display text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-1">FAQ</h1>
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Question &amp; answer pairs shown on the landing page.</p>
